...
namespace TravelBlog.Models
{
  public class TravelBlogContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      .HasData(
        new Review { ReviewId = 1, DestinationId = 6, Title = "Wonderful", Description = "It was wonderful", Rating = 5 },
        new Review { ReviewId = 2, DestinationId = 7, Title = "Wonderful", Description = "It was wonderful", Rating = 4 },
        new Review { ReviewId = 3, DestinationId = 8, Title = "Wonderful", Description = "It was wonderful", Rating = 3 }
      );
    }
  }
}